...
@interface HJPlayerControlView () <UIGestureRecognizerDelegate>
...
@implementation HJPlayerControlView
...
- (void)makeSubViewsConstraints
{
    ...
    [self.backBtn mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.width.height.mas_equalTo(0);//原值26
    }];
