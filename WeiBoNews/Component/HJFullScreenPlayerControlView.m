//
//  HJFullScreenPlayerControlView.m
//  WeiBoNews
//
...
#import "HJFullScreenPlayerControlView.h"
...
@interface HJFullScreenPlayerControlView () <UIGestureRecognizerDelegate>
...
@implementation HJFullScreenPlayerControlView
...
//    }
    if (_fullScreenBtnDidClickedBlock) {
        _fullScreenBtnDidClickedBlock(sender);
    }
}
...
- (UIButton *)fullScreenBtn
{
    if (!_fullScreenBtn) {
        ...
        [_fullScreenBtn setImage:ZFPlayerImage(@"ZFPlayer_shrinkscreen") forState:UIControlStateNormal];
...
- (UIProgressView *)bottomProgressView
{
    if (!_bottomProgressView) {
        ...
        _bottomProgressView.trackTintColor    = [UIColor colorWithWhite:1 alpha:0.6];
    }
